# 2.6 : Transformar un script en una función
# 2.8 : Administración de errores
# 2.9 : Funciones de la biblioteca
# Modificado :  3.8: Un ejemplo práctico de enumerate()
# Modificado :  3.9: La función zip()
import csv
